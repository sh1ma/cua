...
pub use composition::{
    ActAndObserveInput, ActAndObserveOutput, BatchActionsInput, BatchActionsOutput,
    ChildInvocation, CompositeChildOutput, ACT_AND_OBSERVE_DEFAULT_POLL_INTERVAL_MS,
    ACT_AND_OBSERVE_DEFAULT_TIMEOUT_MS, MAX_BATCH_ACTIONS,
};
pub use cursor::{
...
pub fn manifest() -> ContractManifest {
    ...
    tools.extend(composition::contracts());
